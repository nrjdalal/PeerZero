...
export type { TorrentSnapshot } from "@/lib/torrent/engine"
export type { SearchResult } from "@/lib/torrent/search"

// Kick off the background registry refresh loop at boot.
startRegistrySync()
